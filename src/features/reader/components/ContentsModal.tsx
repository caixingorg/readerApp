...
const ContentsModal: React.FC<ContentsModalProps> = ({
        ...
        return (
            ...
            >
                <Box
                    ...
                    paddingRight="m"
                    paddingLeft="m"
                    style={{ paddingLeft: 24 + item.level * 16 }}
                    backgroundColor={isCurrent ? (isDark ? 'glassStrong' : 'glass') : 'transparent'}
                    marginBottom={item.level === 0 ? 'xs' : 'none'}
                >
    ...
    const handleUpdateBookmark = async () => {
        ...
        try {
            ...
            setBookmarks((prev) =>
                prev.map((b) =>
                    b.id === editingBookmark.id ? { ...b, previewText: editText } : b,
                ),
            );
        ...
        return (
            <TouchableOpacity onPress={() => setActiveTab(id)} style={{ flex: 1 }}>
                <Box
                    ...
                    backgroundColor={
                        isActive ? (isDark ? 'cardSecondary' : 'mainBackground') : 'transparent'
                    }
                    style={isActive ? { shadowOpacity: 0.1 } : undefined}
                >
                    <Text
                        variant="small"
                        fontWeight="500"
                            ...
                            {!isContentsOnly && (
                                ...
                                >
                                    ...
                                    {availableTabs.includes('bookmarks') && (
                                        <TabButton
                                            id="bookmarks"
                                            label={t('reader.controls.bookmarks')}
                                        />
                                    )}
                                </Box>
                            )}
                                ...
                                <FlatList
                                    ...
                                    ListEmptyComponent={
                                        <Box
                                            ...
                                            paddingVertical="xxl"
                                        >
                                            <Text color="textTertiary">No bookmarks yet</Text>
                                        </Box>
                                    }
                                />
                            ) : (
                                <FlatList
                                    ...
                                    ListEmptyComponent={
                                        <Box
                                            ...
                                            paddingVertical="xxl"
                                        >
                                            <Text color="textTertiary">No notes yet</Text>
                                        </Box>
                                    }
                                />
                            )}
